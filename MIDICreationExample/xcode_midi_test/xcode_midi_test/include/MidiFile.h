...
class MidiFile {
   public:
      ...
      int       writeTrack                (const char* aFile, int track);
      int       writeTrack                (const string& aFile, int track);
      int       writeTrack                (ostream& out, int track);
      int       writeHeader               (const char* aFile);
      int       writeHeader               (ostream& out);
      int       writeHeader               (const string& aFile);
      int       writeEndOfTrack               (const char* aFile);
      int       writeEndOfTrack               (ostream& out);
      int       writeEndOfTrack               (const string& aFile);
      ...
      int       addTempo                  (int aTrack, int aTick,
                                           double aTempo);
      int       addKeySignature           (int aTrack, int aTick,
                                           int sharps_or_flats, int major_or_minor);
